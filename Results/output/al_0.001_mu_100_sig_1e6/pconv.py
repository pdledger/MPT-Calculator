...
try:
    sys.path.insert(0,"1e1-1e8_81_el_213158_ord_0_POD_13_1e-4")
except:
    pass

from PlotterSettings import PlotterSettings
try:
    sys.path.insert(0,"1e1-1e8_81_el_213158_ord_0_POD_13_1e-4/Functions")
except:
    pass
from Plotters import *

#Frequency arrays
Frequencies = np.genfromtxt("1e1-1e8_81_el_213158_ord_0_POD_13_1e-4/Data/Frequencies.csv",delimiter=",")

#Eigenvalue arrays
EigenValues0 = np.genfromtxt("1e1-1e8_81_el_213158_ord_0_POD_13_1e-4/Data/Eigenvalues.csv",delimiter=",",dtype=complex)
EigenValues1 = np.genfromtxt("1e1-1e8_81_el_213158_ord_1_POD_13_1e-4/Data/Eigenvalues.csv",delimiter=",",dtype=complex)

EigenValues2 = np.genfromtxt("1e1-1e8_81_el_213158_ord_2_POD_13_1e-4/Data/Eigenvalues.csv",delimiter=",",dtype=complex)
EigenValues3 = np.genfromtxt("1e1-1e8_81_el_213158_ord_3_POD_13_1e-4/Data/Eigenvalues.csv",delimiter=",",dtype=complex)
EigenValues4 = np.genfromtxt("1e1-1e8_81_el_213158_ord_3_POD_13_1e-4/Data/Eigenvalues.csv",delimiter=",",dtype=complex)
